...
<div class="user-form box-body">
	...
	<?php if ( User::hasPermission('editUserEmail') ): ?>
		...
		<?= $form->field($model, 'i_phone_no')->textInput(['maxlength' => 15]) ?>

	<?php endif; ?>

	<?php if ( $model->isNewRecord ): ?>

		<?= $form->field($model, 'password')->passwordInput(['maxlength' => 50, 'autocomplete'=>'off']) ?>

		<?= $form->field($model, 'repeat_password')->passwordInput(['maxlength' => 50, 'autocomplete'=>'off']) ?>
	<?php endif; ?>
