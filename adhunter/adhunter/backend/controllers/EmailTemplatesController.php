...
class EmailTemplatesController extends Controller
{
    ...
    {
       $templates =  CampaignEmail::find()->where('fk_i_template_id ='.$id)->andWhere('dt_deleted_at IS NULL')->all();
        if(!empty($templates))
        {
            Yii::$app->session->setFlash('danger', "Can't Delete, This Template is used somewhere");
