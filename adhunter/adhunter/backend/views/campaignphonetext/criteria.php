...
use backend\models\PhoneTextTemplates;
...
?>
                ...
                <?php
                    ...
                    <fieldset   style="border:1px solid #c0c0c0 !important; padding: 10px !important">
                         <legend style="width:43% !important; border-width:0px !important"><input type="radio" name="critera" value="company" checked> Company Criteria</legend>
                    <div id="company-fileds">    
                    <?
                        ...
                        <br>
                        <fieldset style="border:1px solid #c0c0c0 !important; padding: 10px !important">
                        <legend style="width:34% !important; border-width:0px !important"><input type="radio" name="critera" value="user"> User Email Criteria</legend>
                        <div id="user-fileds" >
                        <?php
                        // User Details
...
<script type="text/javascript">
    ...
    $(function(){
         $("#user-fileds :input").attr("disabled", true);
        $('input:radio[name="critera"]').on('change', function(e) {
           if($(this).val() == 'company'){
                $("#company-fileds :input").attr("disabled", false);
                $("#user-fileds :input").attr("disabled", true);
           }             
            else{
                $("#company-fileds :input").attr("disabled", true);
                $("#user-fileds :input").attr("disabled", false);
            }
        });
             ...
             $.ajax({
                  ...
                  success: function (response) {
                       if(response){
                            ...
                            $.event.trigger( "addQueryforPhone", [ response] );
                       }
                       else{
                           console.log("Failed !!!");
                       }
