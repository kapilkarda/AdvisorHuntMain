...
<?php if ( ! empty($comments_by_type['comment']) ) : ?>
                ...
                <div id="comments-list" class="comments" style="overflow: hidden;">
...
<?php if ( 'open' == $post->comment_status ) : ?>
                <div id="respond">
                    <hr>
                    <h2><?php comment_form_title( __('Post a Comment', 'hbd-theme'), __('Post a Reply to %s', 'hbd-theme') ); ?></h2>
...
<?php else : ?>
                    ...
                    <div class="formcontainer">   
                        ...
                        <form id="commentform sky-form3"  class="sky-form comment-style"action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post">
 <fieldset>
<?php if ( $user_ID ) : ?>
...
<?php else : ?>
                ...
                <div class="row sky-space-30">
                        <div id="form-section-author" class="form-section col-md-6">
                                          <!--<div class="form-label"><label for="author"><?php _e('Name', 'hbd-theme') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'hbd-theme') ?></div>-->
                                          <div class="form-input"><input id="author" class=" form-control" name="author" type="text" value="<?php echo $comment_author ?>" placeholder="Name" tabindex="1" required/></div>
                        </div><!-- #form-section-author .form-section -->
           
                        <div id="form-section-email" class="form-section col-md-6">
                                          <!--<div class="form-label"><label for="email"><?php _e('Email', 'hbd-theme') ?></label> <?php if ($req) _e('<span class="required">*</span>', 'hbd-theme') ?></div>-->
                                          <div class="form-input"><input id="email" class="form-control" name="email" type="text" value="<?php echo $comment_author_email ?>"  placeholder="Email" tabindex="2" required/></div>
...
<?php endif /* if ( $user_ID ) */ ?>
           <div class="sky-space-30">
              <div id="form-section-comment" class="form-section">
                                ...
                                <div class="form-textarea"><textarea id="comment" class="form-control" name="comment"  cols="42%" rows="8" tabindex="3" placeholder="Write comment here ......" required></textarea></div>
...
<?php do_action('comment_form', $post->ID); ?>
                            ...
                            <div class="form-submit"><input id="submit" class="btn-u" name="submit" type="submit" value="<?php _e('Submit', 'hbd-theme') ?>" tabindex="7" /><input type="hidden" name="comment_post_ID" value="<?php echo $id; ?>" /></div>
